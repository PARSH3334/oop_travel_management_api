...
public class Dashboard extends JFrame implements ActionListener {
    ...
    JButton addPersonalDetails,veiwPersonalDetails,updatePersonalDetails,checkpackage,bookpackage,viewpackage,viewhotels,destination ,bookhotel,viewBookhotel,payments,calculators,notepad,about;
    String username;
    Dashboard(String username){
       ...
       this.username=username;
        ...
        veiwPersonalDetails =new JButton("Veiw Personal Details");
        ...
        veiwPersonalDetails.setMargin(new Insets(0,0,0,60));
        ...
        checkpackage =new JButton("Check Pakage");
        ...
        bookpackage =new JButton("Book pakage");
       ...
       ImageIcon i4=new ImageIcon(ClassLoader.getSystemResource("icons/home2.png"));
