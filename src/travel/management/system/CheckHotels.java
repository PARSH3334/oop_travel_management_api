...
public class CheckHotels extends JFrame implements Runnable{
    Thread t1;
      ...
      public void run(){
          String[]text=new String []{"JW Marriott hotel","Mardin oriental Hotel","Four Season Hotel","Raddisson Blue Hotel","Classio Hotel ","The Bay Club Hotel","Breez blow Hotel","The taj hotel","Happy morning Hotel","River flow hotel"};
          try{
              for(int i=0;i<=9;i++){
