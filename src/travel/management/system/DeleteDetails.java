...
public class DeleteDetails extends JFrame implements ActionListener{
    ...
    DeleteDetails(String username){
        ...
        JLabel lblnumber=new JLabel("Numbers");
        lblnumber.setBounds(30,170,150,25);
        add(lblnumber);
        
        JLabel labelnumbers=new JLabel("");
        labelnumbers.setBounds(220,170,150,25);
        add(labelnumbers);
        ...
        try{
            ...
            while(rs.next()){
                ...
                labelnumbers.setText(rs.getString("number"));
    ...
    public void actionPerformed(ActionEvent ae) {
         try{
             ...
             c.s.executeUpdate("delete from bookpakage where username ='"+username+"'");
